<?php
#商户公钥文件
define("MERCCERTFILE",dirname(__FILE__)."/user.crt");
#商户私钥文件
define("MERCRRVIFILE",dirname(__FILE__)."/user.key");
#工行公钥文件
define("ICBCCERTFILE",dirname(__FILE__)."/ebb2cpublic.crt");
define("MERCPASSWORD",'ccc');
define("MERID",'ccc');
define("MERACCT",'ccccc');
...
if($action == 'go'){
        ...
        //商户签名数据BASE64编码
        if (strtoupper(substr(PHP_OS,0,3))=="WIN"){//windows系统,请先注册ICBCEBankUtil.dll，这个文件在文档包中的asp文件夹中
