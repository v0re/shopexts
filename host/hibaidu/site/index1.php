...
<div id="search">
	  <div id="searchform">
<form name=f action=<?php echo $config["url"];?>/s><img src="images/search_logo.gif" />&nbsp;&nbsp;<input name=wd type=text id=kw value="site:一下?" size=42 maxlength=100> 
<input type=submit value=<?php echo $config["name"];?>一下 id=sb>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="banner">
    <tr>
      ...
      <td width="10">&nbsp;</td>
      <td align="center" id="banner_2"><img src="images/xiangmu2.jpg" />&nbsp;<img src="images/banner.gif" /></td>
      <td width="10">&nbsp;</td>
