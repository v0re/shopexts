...
class b2c_api_update_store
{
    ...
    public function updateStore(&$sdf, $thisObj)
    {
        ...
        {
            $thisObj->send_user_error(__('需要更新的货品的库存不存在！'), array());
        }
        else
        {
            $has_error = false;
            ...
            if (isset($arr_store) && $arr_store)
            {
                ...
                else
                {
                    ...
                    $thisObj->send_user_error(__('更新库存部分失败！'), $fail_products);
                }
            }
            else
            {
                $thisObj->send_user_error(__('更新的商品的库存信息不存在！'), array());
            }
        }
    }
    ...
    */
    public function updateFreezStore(&$sdf, $thisObj)
    {
        ...
        {
            trigger_error('订单标号不存在！', E_USER_ERROR);
        }
        else
        {
