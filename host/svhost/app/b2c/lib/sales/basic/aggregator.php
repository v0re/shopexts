    ...
    public function getDefaultStandardData() {
        ...
        return array(
                    ...
                    'aggregator'=> array(
                                        ...
                                        'options'=> array(
                                                        'any'=>array('name'=>__('任意一条规则')),
                                                        'all'=>array('name'=>__('所有规则')),
                                                    ),
...
EOF;
    ...
    private function _make_conditions_item_options($aData) {
        if(empty($aData)) $aData = array('all'=>__('-----属性-----'));
        $html = '';
