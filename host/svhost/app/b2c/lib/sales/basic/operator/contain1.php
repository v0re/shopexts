...
class b2c_sales_basic_operator_contain1 implements b2c_interface_sales_operator
{
    public function getOperators() {
        return array(
                    '#()'=> array('name'=>'开头包含', 'value'=>'#()', 'type'=>'contain1', 'object'=>'b2c_sales_basic_operator_contain1', 'alias'=>array('#()')),
                    '()#'=> array('name'=>'结尾包含', 'value'=>'()#', 'type'=>'contain1', 'object'=>'b2c_sales_basic_operator_contain1', 'alias'=>array('()#')),
               );
    }
