...
class b2c_sales_basic_operator_belong implements b2c_interface_sales_operator
{
    public function getOperators() {
        return array(
                    '{}'=>  array('name'=>'属于',   'value'=>'{}',  'type'=>'belong', 'object'=>'b2c_sales_basic_operator_belong', 'alias'=>array('{}')),
                    '!{}'=> array('name'=>'不属于', 'value'=>'!{}', 'type'=>'belong', 'object'=>'b2c_sales_basic_operator_belong', 'alias'=>array('!{}')),
               );
    }
