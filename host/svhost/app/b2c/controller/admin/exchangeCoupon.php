...
class b2c_ctl_admin_exchangeCoupon extends objectPage{
    ...
    function addExchange(){
        ...
        if(empty($_POST['cpns_id']) || $_POST['cpns_id']=='undefined'){
            $this->end(false, __("优惠券名称不能为空"), 'index.php?app=b2c&ctl=admin_sale/exchangeCoupon&act=index');
        }
        ...
        if(!$oExchangeCoupon->saveExchange($_POST)) {
            ...
            $this->end(true, '保存成功', 'index.php?app=b2c&ctl=admin_sale/exchangeCoupon&act=index');
        }
    }
}
?>
