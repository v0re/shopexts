ModeDialog=new Class({
	...
	initialize:function(url,options){
		...
		this.returnValue=value=window.showModalDialog(url,this,config);
		if(this.isSubmit)this.onClose.call(this,value);
	},
	onLoad:function(win){
		this.win=win;
...
finderDialog=new Class({
	...
	options:{			
		...
		if(!$(this.handle))return;
			...
			var fid=form.id.slice(-6);
			this.win.finderGroup[fid].refresh();
		},
