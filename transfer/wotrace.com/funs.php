...
function export_users() {
		...
		//处理用户
		$sql = "Insert into sdb_mall_member(offerid,user,password,name,regtime,email,oicq,mov,tel,city,zip,addr,sex,ip,point,point_history,advance) select 1,user_id,LOWER(user_password),user_name,unix_timestamp(regdate),user_mail,oicq,user_tel,user_tel,city,user_postalcode,user_adds,sex,lastloginip,jifen,jifen,usermoney from 56770_user order by regdate DESC";
		mysql_query($sql) or  err(__LINE__." ".mysql_error());
