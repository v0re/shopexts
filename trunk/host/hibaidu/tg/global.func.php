...
?>
        <div class="head">
        	<div class="head-wrapper">
        		<a href="#" id="Logo" class="logo"><img width="133px" height="43px" src="images/logo.gif" title="<?php echo $config["name"];?>推广" alt="<?php echo $config["name"];?>推广" /></a>
