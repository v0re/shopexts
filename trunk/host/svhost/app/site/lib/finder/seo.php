...
class site_finder_seo
{
    ...
    function column_control($row){
        return '<a href="index.php?app=site&ctl=admin_seo&act=seoset&_finder[finder_id]='.$_GET['_finder']['finder_id'].'&p[0]='.$row['id'].'"  target="dialog::{frameable:true, title:\'添加菜单\', width:400, height:280}">编辑</a>';
    }
