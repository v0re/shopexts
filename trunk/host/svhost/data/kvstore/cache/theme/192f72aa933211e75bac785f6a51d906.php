<?php exit(); ?>a:2:{s:5:"value";s:12389:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper');   echo $this->_fetch_tmpl_compile_require("block/header.html"); ?>
...
<div class="page2_right">
 <?php  echo  $this->_fetch_compile_include('b2c', 'site/member/attr.html', array());  ?> </div>
