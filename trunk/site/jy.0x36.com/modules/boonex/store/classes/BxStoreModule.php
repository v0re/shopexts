...
class BxStoreModule extends BxDolTwigModule {
    ...
    function actionAdministrationManage ($isAdminEntries = false) {
        return parent::_actionAdministrationManage ($isAdminEntries, '_bx_store_admin_delete', '_bx_store_admin_activate');
    }
    ...
    function getGroupName ($mixedId) {
        if ('m' == $mixedId[0]) { 
            ...
            return $a && (int)$a['owner_id'] == 0 ? $this->_oDb->getParam('sys_ps_group_' . $a['id'] . '_title') : $a['title'];
        }
    }
