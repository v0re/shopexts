...
// 'A' configuration
$aDolUrlInfo = parse_url(BX_DOL_URL_ROOT);
$sDolpSubFolder = rtrim($aDolUrlInfo['path'], '/');
...
$shindigConfig = array(
  ...
  'web_prefix' => $sDolpSubFolder . '/modules/boonex/open_social/shindig/php',
  // If you changed the web prefix, add the prefix to these too
  'default_js_prefix' => $sDolpSubFolder . '/modules/boonex/open_social/shindig/php/gadgets/js/',
  'default_iframe_prefix' => $sDolpSubFolder . '/modules/boonex/open_social/shindig/php/gadgets/ifr?',
  ...
  'extension_class_paths' => BX_DIRECTORY_PATH_ROOT . 'modules/boonex/open_social/integration/Shindig',
  ...
  'cache_root' => BX_DIRECTORY_PATH_ROOT . '/tmp/shindig',
