...
class ctl_discuss extends objectPage{
    ...
    var $name='评论';
    var $actionView = 'product/discuss/finder_action.html'; //默认的动作html模板,可以为null
    var $filterView = 'product/discuss/finder_filter.html'; //默认的过滤器html,可以为null
    var $workground = 'member';
    var $object = 'comment/discuss';

    var $disableGridEditCols = "for_comment_id,object_type";
    var $disableColumnEditCols = "for_comment_id,object_type";    
    var $disableGridShowCols = "for_comment_id,object_type";

    function setting(){
        $this->path[] = array('text'=>'评论设置');
    ...
    function detail($comment_id){
        ...
        $this->setView('product/discuss/detail.html');
