...
//
$CON_PAYMENT['CCB'] = '中国建设银行';
$CON_PAYMEMO['CCB'] = '中国建设银行';
$CON_PAYCUR['CCB'] = array("CNY"=>"0");
//
$CON_PAYMENT['ICBC_INST'] = '中国工商银行分期';
$CON_PAYMEMO['ICBC_INST'] = '接工行分期付款';
$CON_PAYCUR['ICBC_INST'] = array("CNY"=>"0");
