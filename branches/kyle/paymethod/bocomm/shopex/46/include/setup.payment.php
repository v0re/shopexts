...
$CON_PAYMENT['WESTPAY'] = $PROG_TAGS["ptag_1481"];
...
$CON_PAYMENT['ECS'] = "ECS Payment Gateway";
$CON_PAYMENT['TWV'] = $PROG_TAGS["ptag_1819"];
$CON_PAYMENT['GWPAY'] = "Green World Payment";
$CON_PAYMENT['ENETS'] = "eNETS Payment Services";
$CON_PAYMENT['PAY100'] = "PAY100.COM";
...
if($ALIPAY_MASS_ENABLE[$SHOP_ID])
	$CON_PAYMENT['ALIPAY_MASS'] = $PROG_TAGS["ptag_alipaymass"];
if($ALIPAY_DIRECT_ENABLE[$SHOP_ID])
	$CON_PAYMENT['ALIPAY_DIRECT'] = $PROG_TAGS["ptag_alipaydirect"];
...
$CON_PAYMEMO['WESTPAY'] = $PROG_TAGS["ptag_1492"];
...
$CON_PAYMEMO['ALIPAY_MASS'] = $PROG_TAGS["ptag_alipaymass_desc"];
$CON_PAYMEMO['ALIPAY_DIRECT'] = $PROG_TAGS["ptag_alipaydirect_desc"];
...
$CON_PAYCUR['NPS_OUT'] = array("CNY"=>"CNY", "USD"=>"USD", "EUR"=>"EUR");
$CON_PAYCUR['WESTPAY'] = array("CNY"=>"");
...
$CON_PAYCUR['GOOGLE'] = array("USD"=>"USD");
$CON_PAYCUR['ALIPAY_MASS'] = array("CNY"=>"01");
$CON_PAYCUR['ALIPAY_DIRECT'] = array("CNY"=>"01");
...
$CON_PAYCUR['OFFLINE'] = array("CNY"=>"CNY","USD"=>"USD","EUR"=>"EUR","GBP"=>"GBP","CAD"=>"CAD","AUD"=>"AUD","NZD"=>"NZD","RUB"=>"RUB","HKD"=>"HKD","TWD"=>"TWD","KRW"=>"KRW","SGD"=>"SGD","JPY"=>"JPY","MYR"=>"MYR","CHF"=>"CHF","SEK"=>"SEK","DKK"=>"DKK","PLZ"=>"PLZ","NOK"=>"NOK","HUF"=>"HUF","CSK"=>"CSK");

###
$CON_PAYMENT['BOCOMM'] = '交通银行';
$CON_PAYMEMO['BOCOMM'] = '交通银行';
$CON_PAYCUR['BOCOMM'] = array("CNY"=>"01");
