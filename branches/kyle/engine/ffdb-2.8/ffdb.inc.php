...
// File:      ffdb.inc.php
// Version:   2.8
// Author:    John Papandriopoulos <jpap at users dot sourceforge dot net>
...
class FFDB
{
   ...
   function removebyfield($fieldname, $regex)
   {
      ...
      // Do an auto-cleanup if required
      if ( ($delete_count > 0) &&
           ($this->auto_clean >= 0) && ($this->deleted > $this->auto_clean) )
         $this->cleanup();
