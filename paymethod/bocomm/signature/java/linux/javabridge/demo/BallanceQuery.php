    ...
    <body bgcolor = "#FFFFFF" text = "#000000">
        <?php
            ...
            if ($code == "0") //交易成功
                ...
                print "<br>------------------------------<br>";
                $opr=$rep->getOpResult();
                $accountNo=$opr->getValueByName("settAccount");
                //$accountName = java_values($opr->getValueByName("accountName")->getBytes("GBK")); //为正确显示中文对返回java变量进行转换
                $accountName=$opr->getValueByName("accountName");
                $currType=$opr->getValueByName("currType");
                $currBalance=$opr->getValueByName("currBalance");
                $validBalance=$opr->getValueByName("validBalance");
